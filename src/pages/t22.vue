        ...
        <table class="table table-hover table-bordered" v-loading="loading">
            <tbody v-if="state_flag == 1 || state_flag == 2">
                <tr>
                    ...
                    <td colspan="2">统一社会信用代码或组织机构代码</td>
                ...
                <tr>
                    <td>注册地点</td>
                    <td colspan="5"><input type="text" class="form-control" v-model="text6" /></td>
                </tr>
                <tr>
                    <td>办公地址</td>
                    <td colspan="5"><input type="text" class="form-control" v-model="text7" /></td>
                </tr>
                <tr>
                    <td rowspan="5">联 系 人</td>
                    <td>姓名</td>
                    <td colspan="4"><input type="text" class="form-control" v-model="text8" /></td>
                </tr>
                <tr>
                    <td>职务</td>
                ...
                <tr>
                    <td>办公电话</td>
                    <td colspan="4"><input type="text" class="form-control" v-model="text10" /></td>
                </tr>
                <tr>
                    <td>手机号码</td>
                    ...
                    <td>电子邮箱</td>
                    <td colspan="4"><input type="text" class="form-control" v-model="text12" /></td>
                </tr>
            </tbody>
            <tbody v-else>
                <tr>
