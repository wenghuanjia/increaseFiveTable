    ...
    <div class="t7">
        <table class="table table-hover table-bordered" v-loading="loading">
            <tbody>
                ...
                <tr>
                    <td colspan="9" align="center">研发人员</td>
                </tr>
                <tr>
                    <td>姓名</td>
                    <td>外聘研发人员</td>
                ...
                <tr v-for="(value, key, index) in text11" :key="index">
                    <td><input type="text" class="form-control" placeholder="请输入" v-model="text11[key]['text1']"/></td>
                    <td><input type="text" class="form-control" placeholder="请输入" v-model="text11[key]['text2']"/></td>
                    <td><input type="text" class="form-control" placeholder="请输入" v-model="text11[key]['text3']"/></td>
                    <td><input type="text" class="form-control" placeholder="请输入" v-model="text11[key]['text4']"/></td>
                    <td><input type="text" class="form-control" placeholder="请输入" v-model="text11[key]['text5']"/></td>
                    <td><input type="text" class="form-control" placeholder="请输入" v-model="text11[key]['text6']"/></td>
                    <td><input type="text" class="form-control" placeholder="请输入" v-model="text11[key]['text7']"/></td>
                    <td><input type="text" class="form-control" placeholder="请输入" v-model="text11[key]['text8']"/></td>
                    <td><input type="text" class="form-control" placeholder="请输入" v-model="text11[key]['text9']"/></td>
                </tr>
                <tr>
                    <td colspan="9"><el-button type="primary" size="mini" @click="add_text('text11')">+</el-button></td>
                </tr>
            </tbody>
        </table>
