<template>
    <div class="t7">
        <table class="table table-hover table-bordered" v-loading="loading">
            <thead>
                <tr>
                    <td colspan="2" class="title">广州市科技计划项目</td>
                </tr>
            </thead>
            <tbody v-if="state_flag == 1 || state_flag == 2">
                <tr>
                    <td colspan="2" class="title">申报书</td>
                </tr>
                <tr>
                    <td>项目名称：</td>
                ...
                <tr>
                    <td>支持领域：</td>
                    <td>新一代信息技术/人工智能/生物医药/军民融合与其他</td>
                </tr>
                <tr>
                    <td>支持子领域：</td>
                ...
                <tr>
                    <td colspan="2" class="title">广州市科技创新委员会</td>
                </tr>
                <tr>
                    <td colspan="2" class="title">二〇一八年制</td>
                </tr>
            </tbody>     
            <tbody v-else>
                <tr>
