<template>
    <div class="t7">
        <table class="table table-hover table-bordered" v-loading="loading">
            <thead>
                <tr>
                    <td colspan="4" class="title">纳统企业2017年企业研发活动情况</td>
                </tr>
            </thead>
            <tbody v-if="state_flag == 1 || state_flag == 2">
                <tr>
                    ...
                    <td>2017年企业研发支出填报数据（单位：万元）</td>
                    <td><input type="text" class="form-control" v-model="text2" /></td>
                </tr>
                <tr>
                    <td colspan="4">备注：申报企业纳入统计部门企业研发（RAD）活动年度统计范围，且2017年研发支出填报数达到300万元以上（含），本表填写数据须与纳统填报数据一样</td>
                </tr>
            </tbody>
            <tbody v-else>
                <tr>
