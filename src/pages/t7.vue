    ...
    <div class="t7">
        <table class="table table-hover table-bordered" v-loading="loading">
            <tbody v-if="state_flag == 1 || state_flag == 2">
                <tr>
                    <td colspan="6" class="title">广东省科技计划项目</td>
                </tr>  
                <tr>
                    <td colspan="6" class="title">申 报 书</td>
                </tr>   
                <tr>
                    <td colspan="6" class="title">（技术开发及产业化类）</td>
                </tr>  
                <tr>
                    <td>*项目名称：</td>    
                ...
                <tr>
                    <td>*专项资金类别：</td>    
                    <td colspan="5"><input type="text" class="form-control" v-model="text2" /></td>
                </tr>
                <tr>
                    <td>*业务类型：</td>    
                    <td colspan="5"><input type="text" class="form-control" v-model="text3" /></td>
                </tr>
                <tr>
                    <td>*申请单位：</td>    
                    <td colspan="5"><input type="text" class="form-control" v-model="text4" /></td>
                </tr>
                <tr>
                    <td>*通讯地址：</td>    
                    <td colspan="5"><input type="text" class="form-control" v-model="text5" /></td>
                </tr>
                <tr>
                    <td>*邮政编码：</td>    
                ...
                <tr>
                    <td>*电子邮箱：</td>    
                    <td colspan="5"><input type="text" class="form-control" v-model="text15" /></td>
                </tr>
                <tr>
                    <td>县（区）主管：</td>    
                ...
                <tr>
                    <td>*推荐单位：</td>    
                    <td colspan="5"><input type="text" class="form-control" v-model="text17" /></td>
                </tr>
                <tr>
                    <td>*申报日期：</td>    
                ...
                <tr>
                    <td colspan="6" class="title">广东省科学技术厅二零一四年一月制</td>
                </tr>           
            </tbody> 
            <tbody v-else>
                <tr>
                ...
                <tr>
                    <td>*专项资金类别：</td>    
                    <td colspan="5">{{text2}}</td>
                </tr>
                <tr>
                    <td>*业务类型：</td>    
                    <td colspan="5">{{text3}}</td>
                </tr>
                <tr>
                    <td>*申请单位：</td>    
                    <td colspan="5">{{text4}}</td>
                </tr>
                <tr>
                    <td>*通讯地址：</td>    
                    <td colspan="5">{{text5}}</td>
                </tr>
                <tr>
                    <td>*邮政编码：</td>    
                    <td>{{text6}}</td>
